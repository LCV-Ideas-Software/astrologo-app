// Módulo: astrologo-frontend/functions/api/_shared/vertex.ts
...
// analisar.ts (models.generateContent / models.countTokens), incluindo
// httpOptions.timeout (AbortSignal na chamada da API) e saída estruturada
// (responseMimeType + responseJsonSchema, validados empiricamente no REST v1).
